...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[tblM_Position](
	[Position_PK] [int] IDENTITY(1,1) NOT NULL,
	[Name] [nvarchar](200) NOT NULL,
	...
	[UpdatedDate] [datetime] NOT NULL,
	[Status_FK] [int] NOT NULL,
 CONSTRAINT [PK_tblM_Position] PRIMARY KEY CLUSTERED 
(
	[Position_PK] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
SET IDENTITY_INSERT [dbo].[tblM_Position] ON
INSERT [dbo].[tblM_Position] ([Position_PK], [Name], [Description], [CreatedBy], [CreatedDate], [UpdatedBy], [UpdatedDate], [Status_FK]) VALUES (1, N'Welder', N'Tukang las', N'admin', CAST(0x0000AA1500CF85BE AS DateTime), N'admin', CAST(0x0000AA1500CF85BE AS DateTime), 1)
...
INSERT [dbo].[tblM_UserDetail] ([UserDetail_PK], [UserCode], [Name], [TglLahir], [FilePhoto], [NoKTP], [NoHP], [Email], [Address], [Description], [CreatedBy], [CreatedDate], [UpdatedBy], [UpdatedDate], [Status_FK]) VALUES (5, N'UserG0002', N'IS', CAST(0xC3150B00 AS Date), NULL, N'3275020202', N'081290909090', N'i.s@gmail.com', N'Alamat 1.2.3', NULL, N'SYSTEM', CAST(0x0000A9C800000000 AS DateTime), N'admin', CAST(0x0000AA15010A149A AS DateTime), 1)
...
INSERT [dbo].[tblM_User] ([User_PK], [UserDetail_FK], [Position_FK], [Username], [Password], [CreatedBy], [CreatedDate], [UpdatedBy], [UpdatedDate], [Status_FK]) VALUES (1, 4, 0, N'UserG0001', N'(diencryp)', N'SYSTEM', CAST(0x0000A9C800000000 AS DateTime), N'SYSTEM', CAST(0x0000A9C800000000 AS DateTime), 3)
INSERT [dbo].[tblM_User] ([User_PK], [UserDetail_FK], [Position_FK], [Username], [Password], [CreatedBy], [CreatedDate], [UpdatedBy], [UpdatedDate], [Status_FK]) VALUES (2, 5, 2, N'UserG0002', N'941dd51c51068f5e17d8c3390c32195e', N'SYSTEM', CAST(0x0000A9C800000000 AS DateTime), N'admin', CAST(0x0000AA15010A149A AS DateTime), 1)
INSERT [dbo].[tblM_User] ([User_PK], [UserDetail_FK], [Position_FK], [Username], [Password], [CreatedBy], [CreatedDate], [UpdatedBy], [UpdatedDate], [Status_FK]) VALUES (5, 8, 0, N'irpan', N'supendi1233', N'admin', CAST(0x0000AA1301036664 AS DateTime), N'admin', CAST(0x0000AA13012EC9D3 AS DateTime), 3)
