...
{
    public class UserDetailEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public UserDetailEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save userDetail.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create userDetail" : "Update userDetail",
                Link = "/userDetail",
