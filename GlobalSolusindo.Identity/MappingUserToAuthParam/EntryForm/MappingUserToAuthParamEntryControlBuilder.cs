...
{
    public class MappingUserToAuthParamEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public MappingUserToAuthParamEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                Type = "Button",
                Text = "Add Role",
                Tooltip = formState == EntryFormState.Create ? "Create mappingUserToAuthParam" : "Update mappingUserToAuthParam",
                Link = "/mappingUserToAuthParam",
