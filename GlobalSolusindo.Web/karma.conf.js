...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/dashboard/dashboard-test.js',
			'app/modules/equipment/equipmentModule.js',
			'app/modules/equipment/equipmentCtrl.js',
			'app/modules/equipment/equipmentRoute.js',
			'app/modules/equipment/equipmentService.js',
			'app/modules/equipment/equipment-test.js',
		],
