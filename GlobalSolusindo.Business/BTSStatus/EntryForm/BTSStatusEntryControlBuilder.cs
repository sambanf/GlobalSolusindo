...
{
    public class BTSStatusEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public BTSStatusEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save btsStatus.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create btsStatus" : "Update btsStatus",
                Link = "/btsStatus",
