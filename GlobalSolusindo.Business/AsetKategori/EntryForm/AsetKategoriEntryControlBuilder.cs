...
{
    public class AsetKategoriEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public AsetKategoriEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save asetKategori.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create asetKategori" : "Update asetKategori",
                Link = "/asetKategori",
