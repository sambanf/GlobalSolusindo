...
{
    public class CostKategoriEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public CostKategoriEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save costKategori.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create costKategori" : "Update costKategori",
                Link = "/costKategori",
