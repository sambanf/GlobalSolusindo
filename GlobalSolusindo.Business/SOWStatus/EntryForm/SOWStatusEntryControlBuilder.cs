...
{
    public class SOWStatusEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public SOWStatusEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save sowStatus.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create sowStatus" : "Update sowStatus",
                Link = "/sowStatus",
