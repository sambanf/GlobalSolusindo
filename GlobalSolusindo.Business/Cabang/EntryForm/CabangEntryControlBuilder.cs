...
{
    public class CabangEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public CabangEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save cabang.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create cabang" : "Update cabang",
                Link = "/cabang",
