...
{
    public class BTSTechnologyEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public BTSTechnologyEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        private bool GetEnabledState()
        {
            ...
            switch (formState)
            {
                case EntryFormState.Create:
                    enabled = accessControl.UserHasRole("BTSTechnology_Input");
                    break;
                case EntryFormState.Update:
                    enabled = accessControl.UserHasRole("BTSTechnology_Edit");
                    break;
                default:
                    break;
            }
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save btsTechnology.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create btsTechnology" : "Update btsTechnology",
                Link = "/btsTechnology",
