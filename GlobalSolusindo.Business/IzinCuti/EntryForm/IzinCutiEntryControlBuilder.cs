...
{
    public class IzinCutiEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public IzinCutiEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        private bool GetEnabledState()
        {
            ...
            switch (formState)
            {
                case EntryFormState.Create:
                    enabled = accessControl.UserHasRole("IzinCuti_Input");
                    break;
                case EntryFormState.Update:
                    enabled = accessControl.UserHasRole("IzinCuti_Edit");
                    break;
                default:
                    break;
            }
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save izinCuti.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create izinCuti" : "Update izinCuti",
                Link = "/izinCuti",
