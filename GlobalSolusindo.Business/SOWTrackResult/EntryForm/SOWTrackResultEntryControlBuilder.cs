...
{
    public class SOWTrackResultEntryControlBuilder : BuilderBase
    { 
        private AccessControl accessControl;

        public SOWTrackResultEntryControlBuilder(GlobalSolusindoDb db, tblM_User user, AccessControl accessControl) : base(db, user)
        { 
    ...
    class SaveButtonBuilder : BuilderBase
    {
        ...
        private bool GetEnabledState()
        {
            ...
            switch (formState)
            {
                case EntryFormState.Create:
                    enabled = accessControl.UserHasRole("SOWTrackResult_Input");
                    break;
                case EntryFormState.Update:
                    enabled = accessControl.UserHasRole("SOWTrackResult_Edit");
                    break;
                default:
                    break;
            }
        ...
        public Button GetButton()
        {
            return new Button()
            {
                ...
                CommandName = "Save",
                CommandDescription = "Save sowTrackResult.",
                Type = "Button",
                Text = "Save",
                Tooltip = formState == EntryFormState.Create ? "Create sowTrackResult" : "Update sowTrackResult",
                Link = "/sowTrackResult",
